...
urlpatterns = [
    ...
    path("id-card/", hod_views.id_card_generator, name='id_card_generator'),
    path("data-tools/", hod_views.data_tools, name='data_tools'),
    path("data-tools/export/", hod_views.export_users_csv, name='export_users_csv'),
    path("data-tools/import/", hod_views.import_users_csv, name='import_users_csv'),
    ...
    path("feedback/manage/", hod_views.manage_feedback, name="manage_feedback"),
    path("leave/manage/", hod_views.manage_leave, name="manage_leave"),
