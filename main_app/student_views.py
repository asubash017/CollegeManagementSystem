    ...
    if request.method == 'POST':
        if form.is_valid():
            try:
                ...
                obj.student = student
                obj.save()
                # Signal in notification_service.py will automatically create notifications
                messages.success(
...
def student_view_profile(request):
    ...
    context = {
        'form': form,
        'student': student,               # ← NEW (for template)
    ...
    if request.method == 'POST':
        try:
            if form.is_valid():
                ...
                admin.gender = gender
                admin.save()
                student.phone = form.cleaned_data.get('phone', '')  # ← NEW
                student.save()
